...
- **2-12 Player Support**: Play with 2, 3, 4, 6, 8, 9, 10, or 12 players
...
### Setup
1. Choose the number of players (2-12)
2. Choose the number of teams (2 or 3)
...
3. The turn automatically advances to the next player
...
- Single device play only (pass-and-play)
- No AI opponents
